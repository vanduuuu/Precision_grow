...
import './Chooseus.css';
import TitleBg from "../../../assets/images/hero_4.webp"
import Earth from '../../../assets/images/earth.webp'
import Icon1 from '../../../assets/shapes/resource.webp'
import Icon2 from '../../../assets/shapes/Bespoke.webp'
import Icon3 from '../../../assets/shapes/data.webp'
import Icon4 from '../../../assets/shapes/Automation.webp'
    ...
    />
            ...
            <div className='col-xl-6 col-lg-12'>
              <div className='earth-img' data-aos="zoom-in-down" data-aos-duration="3000">
                <img src= {Earth} loading="lazy" className='100' alt="earth"/>
              </div>
            </div>
            <div className='col-xl-3 col-lg-12'>
              <Choosecard
