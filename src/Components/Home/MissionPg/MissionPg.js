...
import HomeAbt from '../../../assets/images/planet-earth-global.webp';
import Leaf from '../../../assets/shapes/leaff.webp';
import Vision from '../../../assets/shapes/vision.webp';
import Mission from '../../../assets/shapes/mission.webp'
    ...
    <>
          ...
          <div className="row d-flex">
            <div className="col-xl-6 col-lg-5 col-md-12">
              <div className="inner-mission">
                <img src={HomeAbt} loading="lazy" alt="satellite" ></img>
                <div className="in-left-img"  style={{ transform: "translate(0%, -24.35%) translate3d(0px, 0px, 0px)", translate: "none", rotate: "none", scale: "none" }}>
                  <img src={Leaf}  loading="lazy" alt="leaf" />
                </div>
              </div>
            </div>

            <div className="col-xl-6 col-lg-7 col-md-12  col-sm-12">
              <div className="inner-mission-info" data-aos="fade-up" data-aos-duration="3000">
     ...
     data-aos-duration="1500">
            <div className="col-lg-4">
              <Missioncard
                imageSrc='https://webpagecdnstorage.blob.core.windows.net/precisiongrow/visionwebp'
                mission="Our Vision"
                title="Smart Farming for a Sustainable Future"
            ...
            <div className="col-lg-4">
              <Missioncard
                imageSrc='https://webpagecdnstorage.blob.core.windows.net/precisiongrow/mission.webp'
                mission="Our Mission"
                title="Nurturing Agriculture Through Innovation"
            ...
            <div className="col-lg-4">
              <Missioncard
                imageSrc='https://webpagecdnstorage.blob.core.windows.net/precisiongrow/goal.webp'
                mission="Our Goal"
