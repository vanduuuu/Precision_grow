...
import './Addecrop.css'
import ecropmachine from '../../../assets/images/ecrop-machine.webp'
...
import CerLogo1 from '../../../assets/images/cer-logo-1.webp'
import CerLogo2 from '../../../assets/images/cer-logo-2.webp'
import CerLogo3 from '../../../assets/images/cer-logo-3.webp'
import CerLogo4 from '../../../assets/images/cer-logo-4.webp'
      ...
      <div className='container-fixed ecrop-outer'>
        <section>
            <div className='container-fluid'>
                ...
                <div className='row'>
                    <div className='col-lg-4'>
                        <div className='machinee'>
                            <img src={ecropmachine} loading="lazy" alt="ecrop-device"/>
                        </div>
                    </div>
                    <div className='col-lg-4 text-center'>
                       ...
                       <p className='t1'>Manufactured & Marketed by</p>
                        ...
                        <ul className='ecrop_ul mt-4'>
                            ...
                            <div class="logo-list">
                            <ul>
                                <li><img src={Logo1} loading="lazy" className="logo1" alt="logo"/></li>
                                <li><img src={Logo2} loading="lazy" className="logo1" alt="logo"/></li>
                                <li><img src={Logo3} loading="lazy" className="logo1" alt="logo"/></li>
                                <li><img src={Logo4} loading="lazy" className="logo1" alt="logo"/></li>
                            </ul>
                        </div>
                        </div>
                ...
                <ul class="hr-lines">
                         <li><img src={CerLogo1} loading="lazy" alt="logo"/></li>
                        <li><img src={CerLogo2} loading="lazy" alt="logo"/></li>
                        <li><img src={CerLogo3} loading="lazy" alt="logo"/></li>
                        <li><img src={CerLogo4} loading="lazy" alt="logo"/></li>
                    </ul>
                  </div>
                       </div>
                    </div>
