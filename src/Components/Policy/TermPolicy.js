...
const TermPolicy = () => {
  ...
  return (
    <>
    <Helmet>
                       <title>Terms & Conditions - Precision Grow Agri-Tech Solutions</title>
                       <meta name="description" content="Review Precision Grow's terms and conditions for using our innovative agri-tech solutions. Understand your rights and responsibilities today!" />
