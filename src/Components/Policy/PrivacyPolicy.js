...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      <Helmet>
                       <title>Privacy Policy - Precision Grow Agri-Tech Solutions</title>
                       <meta name="description" content="Read Precision Grow's privacy policy to understand how we protect your data and ensure your privacy while using our agri-tech solutions." />
