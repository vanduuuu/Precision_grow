...
import NameBanner from '../../assets/images/planet-earth-global-2.webp'
...
const RefundPolicy = () => {
  ...
  return (
    <div>
         <Helmet>
                       <title>Refund Policy - Precision Grow Agri-Tech Solutions</title>
                       <meta name="description" content="Learn about Precision Grow's refund policy, ensuring customer satisfaction and transparency in our agri-tech solutions. Shop with confidence today!" />
