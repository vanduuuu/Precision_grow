...
import HeadBanner from '../../assets/images/about1.webp'
import NameBanner from '../../assets/images/hero_44.webp'
import Drone from "../../assets/images/drone-scanning.webp"
import Wheat from '../../assets/images/9.webp'
...
const About = () => {
  ...
  return (
    <div>
       <Helmet>
        <title>About Precision Grow: Innovating Sustainable Agri-Tech Solutions</title>
        <meta name="description" content="Learn how Precision Grow is transforming agriculture with innovative agri-tech solutions that enhance sustainability and crop productivity in India." />
        {/* <meta name="keywords" content="Precision Grow: Advanced Agri-Tech Solutions for Sustainable Farming" /> */}
        <link rel="canonical" href="https://precisiongrow.co.in/about" />
      </Helmet>
          ...
          <div className="row align-center">
            <div className="col-xl-5 col-lg-5">
              <div className="choose-us-thumb">
                <img src={Wheat} alt="Vision&Mission" loading='lazy'/>
              </div>
            </div>
