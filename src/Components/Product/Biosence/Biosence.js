...
import biosence from '../../../assets/images/bio-sense.webp';
import './Biosence.css';
import boichart from '../../../assets/images/bio-chart.webp';
import ease from '../../../assets/shapes/rs.webp';
import rs1 from '../../../assets/shapes/ease1.webp';
import test from '../../../assets/shapes/test.webp';
import rs from '../../../assets/shapes/1.webp';
import biomob from '../../../assets/images/bio-mob.webp'
...
const Biosence = () => {
    ...
    return (
        <div>
                 <Helmet>
        <title>Biosence: Innovative Solutions for Sustainable Agriculture</title>
        <meta name="description" content="Discover Biosence by Precision Grow—advanced agri-tech solutions that enhance crop health and promote sustainable farming practices in India." />
                ...
                <section>
                    <div className='container'>
                        <div className='row'>
                            ...
                            <div className='col-lg-6'>
                                <div>
                                    <img src={biosence} loading="lazy" alt="biosence img" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='container'>
                        ...
                        <div className="col-lg-6 col-md-6 mb-4">
                            <div className="feature-item">
                                <img src={rs} loading="lazy" alt="rs"/>
                                <h4>15 days <br/> 5 mins</h4>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 mb-4">
                            <div className="feature-item">
                            <img src={ease} loading="lazy" alt="rs"/>
                            <h4>₹ 750 <br/>₹ 250</h4>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 mb-4">
                            <div className="feature-item">
                            <img src={test} loading="lazy" alt="rs"/>
                            <h4>On-Site Testing</h4>
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 mb-4">
                            <div className="feature-item">
                            <img src={rs1} loading="lazy" alt="rs"/>
                            <h4>Ease of Use</h4>
                            </div>
                        </div>
                        <div className='col-lg-12'>
                                <div className='biomobb'>
                                    <img src={biomob} loading="lazy" alt="bio-mob"/>
                            ...
                            <div className='col-lg-6'>
                                <div>
                                    <img src={boichart} loading="lazy" alt="how_to_test_soil_image" />
                                </div>
                            </div>
