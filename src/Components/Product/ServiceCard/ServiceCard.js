...
import Offer7 from '../../../assets/wieldfire.webp'
import Offer8 from '../../../assets/farm-boundary.webp'
import Offer9 from '../../../assets/cropAdvisory.webp'
import Offer10 from '../../../assets/regenerativeAgri.webp'
import ecropimg from '../../../assets/bio-sense.webp'
import biosenceimg from '../../../assets/ecrop-machine.webp'
...
const ServiceApi = [
  ...
  },
  {
    ...
    },
    {
      ...
      title: 'Biosense',
      image: biosenceimg,
      detail: "Biosense is a compact and efficient soil testing device designed to address a critical challenge faced by farmers: understanding soil content. This device is portable, accurate, and affordable, offering on-the-spot solutions for soil analysis.Brings the laboratory to the field, allowing farmers to make better-informed decisions about soil health and crop management.",
      link: "/biosense"
  },
  {
    id: 12,
    title: 'e-Crop',
    image: ecropimg,
    detail: "e-Crop is a groundbreaking product in the agriculture sector developed by ICAR-CTCRI. This smart IoT device provides farmers with real-time data on both weather and field conditions, empowering them to make informed decisions about farming activities.At its core, e-Crop is designed to simplify farming and enhance prosperity for farmers",
    link: "/ecrop"
},
];
