...
import Headbanner from '../../../assets/images/ecolo-bg.webp'
import NameBanner from '../../../assets/images/hero_44.webp'
import Circle from '../../../assets/shapes/eco-1.webp'
import Circle1 from '../../../assets/shapes/eco-2.webp'
import Circle2 from '../../../assets/shapes/eco-3.webp'
import Circle3 from '../../../assets/shapes/eco-4.webp'
import Circle4 from '../../../assets/shapes/eco-5.webp'
import toilet1 from '../../../assets/images/ecolo-1.webp'
import toilet2 from '../../../assets/images/ecolo-3.webp'
import toilet3 from '../../../assets/images/toilet.webp'
import icon1 from '../../../assets/shapes/save-energy.png'
import icon2 from '../../../assets/shapes/sandclock.png'
import icon3 from '../../../assets/shapes/carbon.webp'
     ...
     <Helmet>
      ...
      <div className="container-fixed">
        <div className="ecoloo-outer">
          <img src={Headbanner} loading="lazy" alt="ecoloo banner" />
        </div>
                ...
                <div class="timeline">
                  <div class="timeline-item left">
                    <div class="circle-img">
                      <img src={Circle} loading="lazy" alt="Eco-Friendly" />
                    </div>
                  ...
                  <div class="timeline-item right">
                    <div class="circle-img">
                      <img src={Circle1} loading="lazy" alt="Odour-Free" />
                    </div>
                    <div class="timeline-content">
                      <h4>Odour-Free</h4>
                      <p>
                  ...
                  <div class="timeline-item left">
                    <div class="circle-img">
                      <img src={Circle2} loading="lazy" alt="Water-Free" />
                    </div>
                    <div class="timeline-content">
                      <h4>Water-Free</h4>
                      <p>
                  ...
                  <div class="timeline-item right">
                    <div class="circle-img">
                      <img src={Circle3} loading="lazy" alt="Sewage-Free" />
                    </div>
                    <div class="timeline-content">
                      <h4>Sewage-Free</h4>
                      <p>
                  ...
                  <div class="timeline-item left">
                    <div class="circle-img">
                      <img src={Circle4} loading="lazy" alt="Energy-Free" />
                    </div>
                    <div class="timeline-content">
                      <h4>Energy-Free</h4>
                      <p>
                      ...
                      >
                        ...
                        >
                          <div class="row">
                            ...
                            <div class="col-lg-5">
                              <div class="tab-img">
                                <img src={toilet1} loading="lazy" alt="perfect harmony with environment" />
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          <div class="row">
                            ...
                            <div class="col-lg-5">
                              <div class="tab-img">
                                <img src={toilet2} loading="lazy" alt="toiletimg"/>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        >
                          <div class="row">
                            ...
                            <div class="col-lg-5">
                              <div class="tab-img">
                              <img src={toilet3} loading="lazy" alt="environmental requirement" />
