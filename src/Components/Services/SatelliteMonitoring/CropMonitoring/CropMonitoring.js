...
import Headbanner from '../../../../assets/images/hero_44.webp'
import Parametr from '../../../../assets/images/parameters.webp'
import cropmonitoringg from '../../../../assets/video/satellite-crop-monitoring.webm'
...
const CropMonitoring = () => {
  ...
  return (
    ...
    <Helmet>
        ...
        <meta name="description" content="Enhance crop yield with Precision Grow's innovative crop monitoring solutions. Leverage satellite technology for smarter, sustainable farming practices." />
        {/* <meta name="keywords" content="Precision Grow: Advanced Agri-Tech Solutions for Sustainable Farming" /> */}
        <link rel="canonical" href="https://precisiongrow.co.in/crop-monitoring" />
      </Helmet>
