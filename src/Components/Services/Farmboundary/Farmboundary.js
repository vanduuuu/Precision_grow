...
import iconimg1 from "../../../assets/shapes/API-Ready-High-Accuracy.webp";
import iconimg2 from "../../../assets/shapes/High-Accuracy.webp";
import iconimg3 from "../../../assets/shapes/PredictablePricing.webp";
import "./Farmboundary.css";
//import farmboundary from "../../../assets/farmboundary.mp4";
import farmbimg from '../../../assets/images/farmboundary1.webp'
...
const Farmboundary = () => {
  ...
  return (
    <div>
       <Helmet>
        <title>Farm Boundary Solutions for Sustainable Agriculture | Precision Grow</title>
        <meta name="description" content="Discover Precision Grow's innovative farm boundary solutions to enhance productivity and sustainability in agriculture. Transform your farming practices today!" />
        {/* <meta name="keywords" content="Precision Grow: Advanced Agri-Tech Solutions for Sustainable Farming" /> */}
        <link rel="canonical" href="https://precisiongrow.co.in/Farmboundary" />
      </Helmet>
          ...
          <div className="col-lg-6">
            ...
            <div className="col-lg-5">
              <div className="frmimg">
                <img src={farmbimg} loading="lazy" alt="fimg"/>
                </div>
            </div>
