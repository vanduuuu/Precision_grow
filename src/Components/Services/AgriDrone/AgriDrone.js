...
import SDS from '../../../assets/images/sds.webp'
import Videobg from '../../../assets/video/agri-drone.mp4';
...
const AgriDrone = () => {
  ...
  return (
    <div>
      <Helmet>
        <title>Innovative Agri-Drones for Precision Farming Solutions</title>
        <meta name="description" content="Discover Precision Grow's agri-drones to enhance crop management, boost yields, and promote sustainable farming practices in India." />
