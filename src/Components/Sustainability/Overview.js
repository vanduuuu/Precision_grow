...
import Goals from '../../assets/images/ship_1.webp'
import Sustainable from '../../assets/images/Sustainable-Development-Goals.webp'
import GoalsHead from '../../assets/shapes/lg2.webp'
import life from '../../assets/images/sustainable-still-life.webp'
...
const Overview = () => {
  ...
  return (
    <div>
       <Helmet>
        <title>Sustainability Overview - Precision Grow Agri-Tech Solutions</title>
        <meta name="description" content="Discover how Precision Grow promotes sustainable farming practices to enhance crop yield and protect the environment in India." />
        {/* <meta name="keywords" content="Precision Grow: Advanced Agri-Tech Solutions for Sustainable Farming" /> */}
        <link rel="canonical" href="https://precisiongrow.co.in/sustainability-overview" />
      </Helmet>
        <Banner 
        ...
        <section>
          ...
          />
                    ...
                    <div className='col-lg-6 offset-lg-1'>
                        <div className='tine'>
                            <img src={Sustainable} loading="lazy" alt="wheel earth" className='wheelll'/>
                            <div className='innerSimg'>
                                <img src={GoalsHead} loading="lazy" alt="lg-logo"/>
                            </div>
