...
const Glossary = () => {
  ...
  return (
    <div>
       <Helmet>
        <title>Sustainability Glossary | Precision Grow</title>
        <meta name="description" content="Explore key terms in sustainability and agri-tech. Enhance your knowledge and practices for a greener future with Precision Grow's comprehensive glossary." />
        {/* <meta name="keywords" content="Precision Grow: Advanced Agri-Tech Solutions for Sustainable Farming" /> */}
        <link rel="canonical" href="https://precisiongrow.co.in/sustainability-glossary" />
      </Helmet>
      {/* Banner Section */}
      <Banner
